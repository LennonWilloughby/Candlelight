...
public class EnemyRed : MonoBehaviour {
	...
	public float noiseThreshold = 5.0f; // how loud the noise needs to be for the enemy to react
	...
	private Vector3 lastKnownPosition; // holds last know position of player
	private float lastKnownDistance; // holds distance between last known position of player and current enemy position
